pipeline {
  ...
  environment {
        ...
        SONARQUBE_TAGS = "demo-www.eea.europa.eu,www.eea.europa.eu-en,www.eea.europa.eu,www.eionet.europa.eu,biodiversity.europa.eu,forest.eea.europa.eu,industry.eea.europa.eu"
          ...
          "Ruff": {
            node(label: 'docker') {
              script {
                ...
                sh '''cp -rf eea.geolocation/* .'''
                sh '''rm -rf eea.geolocation'''
